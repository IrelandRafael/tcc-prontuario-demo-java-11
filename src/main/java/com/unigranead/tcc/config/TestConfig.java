...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		Login lgpc1 = new Login(null, "rafael.estrela", encoder.encode("123"), "ADMIN");
		Login lgpc2 = new Login(null, "fiona.silva", encoder.encode("123"), "ADMIN");
		Login lfun3 = new Login(null, "pedro.silva", encoder.encode("123"), "ADMIN");
		Login lfun4 = new Login(null, "maria.silva", encoder.encode("123"), "ADMIN");
		Login lfun5 = new Login(null, "antonella.silva", encoder.encode("123"), "ADMIN");
		Login lfun6 = new Login(null, "rafaela.silva", encoder.encode("123"), "ADMIN");
		Login lfun7 = new Login(null, "joao.costa", encoder.encode("123"), "ADMIN");
		Login lfun8 = new Login(null, "fabi.pereira", encoder.encode("123"), "ADMIN");
